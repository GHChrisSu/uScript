...
[AddComponentMenu("uScript/Graphs/PlayerScript")]
public class PlayerScript_Component : uScriptCode
{
   #pragma warning disable 414
   public PlayerScript ExposedVariables = new PlayerScript( ); 
   ...
   void OnDestroy( )
   {
      ...
      void OnDrawGizmos( )
      {
         ...
         {
            GameObject gameObject;
            gameObject = GameObject.Find( "Point light" ); 
            if ( null != gameObject ) Gizmos.DrawIcon(gameObject.transform.position, "uscript_gizmo_variables.png");
         }
      }
   #endif
